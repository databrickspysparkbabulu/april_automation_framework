...
url = 'jdbc:snowflake://fsvwopr-mm93561.snowflakecomputing.com/?user=BBHOI9427&password=Maabapa@7&warehouse=COMPUTE_WH&db=SAMPLEDB&schema=CONTACTINFOSCH'
file.write.mode("overwrite") \
    .format("jdbc") \
    .option("driver", "net.snowflake.client.jdbc.SnowflakeDriver") \
    .option("url", url) \
    .option("dbtable", "SAMPLEDB.CONTACTINFOSCH.CONTACT_INFO_RAW") \
    .save()
...
contact_info_bronze.write.mode("overwrite") \
    ...
    .option("driver", "net.snowflake.client.jdbc.SnowflakeDriver") \
    .option("url", url) \
    .option("dbtable", "SAMPLEDB.CONTACTINFOSCH.CONTACT_INFO_BRONZE") \
    .save()
...
contact_info_silver.write.mode("overwrite") \
    ...
    .option("driver", "net.snowflake.client.jdbc.SnowflakeDriver") \
    .option("url", url) \
    .option("dbtable", "SAMPLEDB.CONTACTINFOSCH.CONTACT_INFO_SILVER") \
    .save()
