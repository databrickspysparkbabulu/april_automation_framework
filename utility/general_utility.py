...
def read_schema(schema_file_path):
    ...
    return schema
print('read_schema',read_schema('contact_info_schema.json'))

def fetch_file_path(file_name):
    path = os.path.dirname(given_path) + '/source_files/'+file_name
    return path
print(fetch_file_path('Contact_info.csv'))
def read_config(database):
    ...
    return config
print(read_config('snowflake_db'))
...
print("r2b_query", fetch_transformation_query_path('contact_info_r2b_transformation.sql'))
print("b2c_query", fetch_transformation_query_path('contact_info_b2s_transformation.sql'))
